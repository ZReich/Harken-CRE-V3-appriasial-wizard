...
export default function FloatingDropPanel({
  ...
  return createPortal(
    ...
    >
      ...
      {/* Panel */}
      <div className="absolute inset-y-0 right-0 w-[280px] bg-white/95 backdrop-blur-xl border-l border-gray-200 shadow-2xl shadow-black/20 flex flex-col">
        {/* Header */}
        <div className="flex-shrink-0 px-4 py-4 border-b border-gray-200 bg-gradient-to-br from-[#0da1c7]/15 via-[#4db8d1]/10 to-white">
            ...
            return (
              ...
              >
                ...
                <div className={`
                  ...
                  bg-gradient-to-r from-${category.color}-50 to-white
                  border-b border-${category.color}-100/50
                `}>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <p className={`text-sm font-medium truncate ${isHovered ? 'text-[#0da1c7]' : 'text-gray-700'}`}>
                            {slot.label}
                          </p>
        ...
        {/* Footer hint */}
        <div className="flex-shrink-0 px-4 py-3 border-t border-gray-200 bg-gray-50/80">
