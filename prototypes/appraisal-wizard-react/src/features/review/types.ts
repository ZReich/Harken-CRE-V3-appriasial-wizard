...
export interface ReportSection {
  id: string;
  label: string;
  type: 'cover' | 'section' | 'toc' | 'letter' | 'summary-table' | 'narrative' | 'analysis-grid' | 'photo-grid' | 'map' | 'document' | 'addenda-header' | 'addenda-list' | 'risk-rating' | 'demographics' | 'economic-context' | 'swot';
