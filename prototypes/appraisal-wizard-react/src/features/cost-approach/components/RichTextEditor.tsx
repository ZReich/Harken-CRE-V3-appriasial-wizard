        ...
        `}>
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center gap-1 pl-3">
              <button className="p-1.5 rounded hover:bg-harken-gray-light dark:hover:bg-elevation-3 text-harken-gray dark:text-slate-200 transition-colors"><AlignLeft size={16} /></button>
              <button className="p-1.5 rounded hover:bg-harken-gray-light dark:hover:bg-elevation-3 text-harken-gray dark:text-slate-200 transition-colors"><List size={16} /></button>
              <button className="p-1.5 rounded hover:bg-harken-gray-light dark:hover:bg-elevation-3 text-harken-gray dark:text-slate-200 transition-colors"><ListOrdered size={16} /></button>
            </div>
          </div>
