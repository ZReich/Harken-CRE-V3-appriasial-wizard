...
const GoogleMapAreaInfoCost: React.FC<any> = ({ approachId }: any) => {
  ...
  const { data: costApproch, refetch } = useGet<any>({
    queryKey: `appraisals/get-cost-approach?appraisalId=${id}&appraisalApproachId=${approachId}`,
    endPoint: `appraisals/get-cost-approach?appraisalId=${id}&appraisalApproachId=${approachId}`,
...
export default GoogleMapAreaInfoCost;
