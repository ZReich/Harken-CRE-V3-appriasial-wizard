...
const GoogleMapAreaInfoLease: React.FC<any> = ({ approachId }: any) => {
  ...
  const { data: leaseApproch, refetch } = useGet<any>({
    queryKey: `appraisals/get-lease-approach?appraisalId=${id}&appraisalApproachId=${approachId}`,
    endPoint: `appraisals/get-lease-approach?appraisalId=${id}&appraisalApproachId=${approachId}`,
