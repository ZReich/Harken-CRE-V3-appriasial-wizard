    ...
    <>
      <div>
        ...
        <Grid container spacing={3} className="mt-2 items-end">
          <Grid item xs={values.exterior === AmenitiesEnum.TYPE_MY_OWN ? 3 : 6} className='pt-2'>
            <SelectTextField
          ...
          <Grid item xs={values.roof === AmenitiesEnum.TYPE_MY_OWN ? 3 : 6} className='pt-2'>
            <SelectTextField
        ...
        <Grid container spacing={3} className="mt-2 items-end">
          ...
          <Grid item xs={values.plumbing === AmenitiesEnum.TYPE_MY_OWN ? 3 : 6} className='pt-2'>
            <SelectTextField
        ...
        <Grid container spacing={3} className="mt-2 items-end">
          ...
          <Grid item xs={values.windows === AmenitiesEnum.TYPE_MY_OWN ? 3 : 6} className='pt-2'>
            <SelectTextField
