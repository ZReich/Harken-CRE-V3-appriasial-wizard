...
import LeaseFilterMapHeaderOptions from './lease-filter-menu-option';
import LeaseFilterLandMapHeaderOptions from './lease-filter-menu-option-land';
...
const LeaseApproachForm: React.FC = () => {
  ...
  console.log('LeaseApproachForm - comparisonBasisView:', comparisonBasisView);
  console.log('LeaseApproachForm - location.state:', location.state);
            ...
            return (
              <Form className="w-full">
                {activeType === 'building_with_land' ? (
                  <LeaseFilterMapHeaderOptions
                    comparisonBasisView={comparisonBasisView}
                  />
                ) : (
                  <LeaseFilterLandMapHeaderOptions
                    comparisonBasisView={comparisonBasisView}
                  />
                )}
              </Form>
...
export default LeaseApproachForm;
