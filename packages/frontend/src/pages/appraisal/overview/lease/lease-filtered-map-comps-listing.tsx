...
const LeaseFilteredMapSideListing: React.FC<CompsListingMapProps> = ({
  ...
  const fetchComposData = async (values: any, setValues: any) => {
    try {
      ...
      const response = await axios.get(
        `appraisals/get-lease-approach?appraisalId=${id}&appraisalApproachId=${salesId}`,
        {}
      );
  ...
  const backToApproach = () => {
    navigate(`/lease-approach?id=${id}&leaseId=${salesId}`);
  };
...
export default LeaseFilteredMapSideListing;
