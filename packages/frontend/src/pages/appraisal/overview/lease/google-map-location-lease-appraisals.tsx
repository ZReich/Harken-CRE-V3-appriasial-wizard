...
const GoogleMapLocationLeaseAppraisals: React.FC<SendTypeItem> = ({
  GoogleData,
  ...
  const viewListingItem = (id: number) => {
    ...
    navigate(`/lease-comps-view/${id}/${check}`, {
      state: {
        ...
        try {
          if ((cluster as any).bounds) {
            ...
            google.maps.event.addListenerOnce(map, 'bounds_changed', () => {
              ...
              setTimeout(() => {
                // Multi-property clusters only zoom, no InfoWindow display
              }, 500);
            });
          } else {
...
export default GoogleMapLocationLeaseAppraisals;
