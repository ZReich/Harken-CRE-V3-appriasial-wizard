...
import CostFilterMapHeaderOptions from './cost-filter-menu-option';
import CostFilterLandMapHeaderOptions from './cost-filter-menu-option-land';
              ...
              <>
                <Form className="w-full">
                  {activeType === 'building_with_land' ? (
                    <CostFilterMapHeaderOptions />
                  ) : (
                    <CostFilterLandMapHeaderOptions />
                  )}
                </Form>
              </>
            </>
