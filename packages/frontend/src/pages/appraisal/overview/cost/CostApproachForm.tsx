    ...
    <>
      <Formik
        initialValues={{
          ...
          // New Cost Analysis Fields
          buildingType: 'Light Manufacturing',
          unitCost: 113.36,
          unitQuantity: 9425,
          physicalDepreciation: 11.4,
          economicDepreciation: 0,
          functionalDepreciation: 0,
          siteImprovements: 70000,
          actualBuildingCost: 1300000,
          actualDepreciationPct: 0,
          estimatedLandValue: 238350,
        }}
