...
import ViewPhotoPage from './ViewPhotoPage';
// import {
//   Photo,
...
import { SortableItem } from './AppraisalPhotoSheetSortableItem';
...
const AppraisalPhotoSheetTable = ({
  showValidation,
  setInitialState,
  initialState,
  srcArray,
...
export default AppraisalPhotoSheetTable;
