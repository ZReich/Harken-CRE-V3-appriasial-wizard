...
import { AnalysisEnum } from './OverviewEnum';
        ...
        <Grid container spacing={3} className="mt-3 items-end">
          <Grid item xs={6} xl={3} className="common-label-wrapper pt-2">
            <DatePickerComp
              ...
              value={values.date_of_analysis ? moment(values.date_of_analysis, 'MM/DD/YYYY') : null}
          ...
          <Grid item xs={6} xl={3} className="common-label-wrapper pt-2">
            <DatePickerComp
             ...
             value={values.effective_date ? moment(values.effective_date, 'MM/DD/YYYY') : null}
              onChange={(value: Date | null) => {
                if (value) {
                  const formattedDate = moment(value).format('MM/DD/YYYY');
                  handleChange({
          ...
          <Grid item xs={6} xl={3} className="common-label-wrapper pt-2">
            ...
            value={values.report_date ? moment(values.report_date, 'MM/DD/YYYY') : null}
              onChange={(value: Date | null) => {
                if (value) {
                   const formattedDate = moment(value).format('MM/DD/YYYY');
                  handleChange({
