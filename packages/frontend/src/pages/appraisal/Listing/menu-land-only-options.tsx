...
import LandOnlyAppraisalListingTable from './land-only-index';
const MapHeaderOptionsLandOnlyAppraisal = () => {
...
export default MapHeaderOptionsLandOnlyAppraisal;
