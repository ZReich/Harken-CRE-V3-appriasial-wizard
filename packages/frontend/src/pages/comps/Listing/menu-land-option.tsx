...
const MapHeaderLandOptions = () => {
  ...
  console.log('🎯 MENU - selectedButton current value:', selectedButton);
  console.log('🎯 MENU - localStorage view:', localStorage.getItem('view'));
  console.log(
    '🎯 MENU - localStorage selectedToggle:',
  ...
  return (
    <>
      ...
      {selectedButton == 'android' ? (
        <>
          {console.log(
            '🎯 MENU - Rendering CompsListingMap (selectedButton is android)'
          )}
          <CompsListingMap
        ...
        <>
          {console.log(
            '🎯 MENU - Rendering CompsLandMapListingIntegrated (selectedButton is NOT android)'
          )}
