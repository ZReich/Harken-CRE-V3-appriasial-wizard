      ...
      <div>
        ...
        <div className="mt-6">
          <Grid container spacing={3} className='items-end'>
            ...
            ) : localStorage.getItem('activeType')==='building_with_land' && passData.comp_type==='land_only' ? (
              <>
              <Grid
                item
                xs={
            ...
            <Grid
              ...
              xs={
                localStorage.getItem('activeType') === 'building_with_land'
                  ? 6
                  :localStorage.getItem('activeType') === 'building_with_land' && passData.comp_type==='land_only' ? 3: 3
              }
              className=""
            >
              <StyledField
                label={
                  <span className="relative z-10">
                    ...
                    {localStorage.getItem('activeType') === 'land_only' && passData.length===0 ? (
              ...
              />
              {localStorage.getItem('activeType') === 'land_only' && setDataRequited &&
              values?.land_size == '' ? (
                <div className="text-red-500 text-[11px] pt-1 absolute">
                  This field is required.
                </div>
          ...
          <Grid container spacing={3} className="mt-3 items-end">
            ...
            >
              <SelectTextField
                ...
                label={<span className='relative'>{CreateCompsEnum.FRONTAGE}</span>}
