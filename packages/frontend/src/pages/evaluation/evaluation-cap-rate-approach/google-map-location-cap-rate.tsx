...
const GoogleMapLocationCap: React.FC<SendTypeItem> = ({
  GoogleData,
          ...
          >
            ...
            >
              ...
              <Box className="text-sm flex-1 py-3">
                    ...
                    <Tooltip
                      title={
                        !hoveredInfoWindow?.property?.building_size
                          ? 'N/A'
                          : `${hoveredInfoWindow?.property?.building_size?.toLocaleString()} SF`
                      }
                    >
                      <p className="font-normal text-gray-900 text-ellipsis overflow-hidden whitespace-nowrap max-w-[120px]">
                        {!hoveredInfoWindow?.property?.building_size
                ...
                {/* Land size (building_with_land example) */}
                {localStorage.getItem('activeType') ===
                  'building_with_land' && (
                  <Box className="flex gap-1 flex-wrap">
                    <p className="text-sm font-normal text-gray-900">
                      ...
                      title={
                        ...
                        'ACRE'
                          ? !hoveredInfoWindow?.property?.land_size
                            ? 'N/A'
                            : `${(hoveredInfoWindow?.property?.land_size ?? 0 * 43560).toLocaleString()} SF`
                          : !hoveredInfoWindow?.property?.land_size
                            ? 'N/A'
                            : `${hoveredInfoWindow?.property?.land_size?.toLocaleString()} SF`
                      }
                    >
                      <p className="text-[13px] font-normal text-gray-900 text-ellipsis overflow-hidden whitespace-nowrap max-w-[120px]">
                ...
                <div className="flex justify-end items-center mt-2.5">
                  ...
                  <Box>
                    <CommonButton
                      ...
                      onClick={(e: any) => {
                        e.stopPropagation();
                        if (hoveredInfoWindow?.property?.id !== undefined) {
...
export default GoogleMapLocationCap;
