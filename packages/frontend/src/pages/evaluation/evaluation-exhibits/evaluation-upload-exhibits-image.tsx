...
const EvaluationUploadImageExhibits = ({
  refetch,
  setLoaderClassName,
  loaderClassName,
}: any) => {
  ...
  const { mutateAsync } = useMutate<any, FormDataObject>({
    queryKey: 'evaluations/upload-exhibits',
    endPoint: `evaluations/upload-exhibits/${id}`,
...
export default EvaluationUploadImageExhibits;
