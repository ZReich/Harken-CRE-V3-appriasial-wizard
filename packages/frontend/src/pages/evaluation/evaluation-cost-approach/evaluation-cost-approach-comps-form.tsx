...
const EvaluationCostApproachCompsForm: React.FC = () => {
              ...
              <>
                <Form className="w-full">
                  {activeType === 'building_with_land' ? (
                    <EvaluationCostFilterMapHeaderOptions />
                  ) : (
                    <EvaluationCostFilterLandMapHeaderOptions />
                  )}
                </Form>
              </>
            </>
...
export default EvaluationCostApproachCompsForm;
