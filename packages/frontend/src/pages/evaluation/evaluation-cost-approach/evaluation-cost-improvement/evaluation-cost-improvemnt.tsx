...
import CostImprovementDepreciation from './evaluation-cost-improvement-depriciation';
export const EvaluationCostImprovement = ({
  updateData,
  totalSqft,
  totalAdjustedCost,
              ...
              return (
                <>
                  <Grid
                    container
                    spacing={1}
                    className="w-full mt-[7px] font-bold text-black"
                  >
                    ...
                    <Grid item xs={2} className="pl-[24px] break-all">
                      <div className="flex items-center">
                        ...
                        <Tooltip
                          title={<CostImprovementDepreciation />}
                    ...
                    values.improvements.map((zone: any, i) => {
                      ...
                      return (
                        <Grid
                          ...
                          spacing={1}
                          key={i}
                          className="w-full mt-[7px] items-end"
                        >
                          <Grid item xs={3} className="pl-[24px] break-all">
                            <StyledField
                          ...
                          <Grid item xs={2} className="pl-[24px] break-all">
                            <div className="mb-0 w-full">
                              <Field
                                ...
                                value={values?.improvements[i]?.adjusted_psf === '0' ? '' : values?.improvements[i]?.adjusted_psf}
                              />
                            </div>
                          </Grid>
                          <Grid item xs={2} className="pl-[24px] break-all">
