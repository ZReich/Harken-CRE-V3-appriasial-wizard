...
import EvaluationLeaseCompsAdvanceFilter from './evaluation-lease-comps-advance-filter';
...
const EvaluationLeaseFilterMapHeaderOptions: React.FC<any> = ({
  // passCompsData,
  tableData,
}) => {
  ...
  const triggerLocalStorageUpdate = () => {
    ...
    console.log(
      '🔄 LEASE PARENT: Triggered localStorage update for integrated component',
      mapData,
      setMapData
    );
  };
  ...
  return (
    <>
      ...
      <EvaluationLeaseCompsAdvanceFilter
        isOpen={isOpen}
        setIsOpen={setIsOpen}
        sendTypes={sendTypes}
...
export default EvaluationLeaseFilterMapHeaderOptions;
