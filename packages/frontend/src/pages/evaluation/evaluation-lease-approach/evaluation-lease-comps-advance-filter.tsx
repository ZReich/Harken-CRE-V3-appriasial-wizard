...
const EvaluationLeaseCompsAdvanceFilter: React.FC<MapFilterProps> = ({
  isOpen,
  setIsOpen,
  onApplyFilter,
  passDataCheckType,
  ...
  React.useEffect(() => {
    if (newdata?.data?.data) {
      ...
      if (Array.isArray(rawData)) {
        ...
        // Remove console.error to prevent performance issues
  ...
  const handleSubmit = async (value: FormData) => {
    ...
    const priceMax = localStorage.getItem('price_sf_max')
      ...
      : value.price_sf_max
        ...
        : null;
    // const comparison_basis = localStorage.getItem('comparison_basis');
    ...
    const params: Omit<FilterComp, 'search'> = {
      // comaprison_basis: comparison_basis,
...
export default EvaluationLeaseCompsAdvanceFilter;
