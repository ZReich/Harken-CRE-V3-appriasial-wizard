...
import EvaluationSalesFilteredCompsList from './evaluation-sales-filetered-comps-listing';
import EvaluationCompsAdvanceFilter from './evaluation-comps-advance-filter';
import { useLocation } from 'react-router-dom';
import EvaluationSalesMapListingIntegrated from './evaluation-sales-map-listing-integrated';
...
const EvaluationFilterLandMapHeaderOptions: React.FC<any> = ({
  // passCompsData,
  tableData,
  comparisonBasisView,
}) => {
  ...
  return (
    <>
      ...
      />
      {selectedButton == 'android' ? (
        <EvaluationSalesFilteredCompsList
        ...
        <>
          ...
          <EvaluationSalesMapListingIntegrated
            typeFilter={selectType}
...
export default EvaluationFilterLandMapHeaderOptions;
