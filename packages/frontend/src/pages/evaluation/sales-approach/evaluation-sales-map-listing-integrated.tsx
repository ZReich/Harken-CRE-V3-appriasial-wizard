...
import GoogleMapLocationSales from './google-map-location-sales';
import EvaluationSalesMapSideFilteredListing from './evaluation-sales-map-side-filtered-listing';
...
const EvaluationSalesMapListingIntegrated: React.FC<
...
> = (props) => {
  ...
  console.log('selectedToggleButton', props.selectedToggleButton);
  ...
  return (
    <Grid container spacing={2} sx={{ height: 'calc(100vh - 120px)' }}>
      ...
      <Grid item xs={12} md={6} lg={4}>
        <EvaluationSalesMapSideFilteredListing
          {...props}
...
export default EvaluationSalesMapListingIntegrated;
