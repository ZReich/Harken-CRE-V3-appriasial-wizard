...
const EvaluationAiSalesCompsData = ({
  handleClose,
  onClose,
  open,
  compsData,
  ...
  console.log(compsLength, subZoneOptions, 'compsLength');
  ...
  const tableColumns: string[] = [
    ...new Set([
      ...
      ...Object.keys(columnHeaders)
        ...
        .filter((key) => {
          // Show *_custom fields only if their main field is "Type My Own"
          ...
          if (key === 'lot_shape_custom') {
            return formik.values.comps.some(
              (row: CompRow) => row.lot_shape === 'Type My Own'
            );
          }
...
export default EvaluationAiSalesCompsData;
