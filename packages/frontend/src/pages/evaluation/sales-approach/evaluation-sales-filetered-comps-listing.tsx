...
const EvaluationSalesFilteredCompsList: React.FC<CompsListingMapProps> = ({
  typeFilter,
              ...
              >
                ...
                <Box className="w-44 flex flex-col justify-between">
                  <Box className="flex justify-end">
                    ...
                    <a
                      href={`/evaluation/sales-comps-view/${item.id}`}
                      onClick={(e) => {
                        e.preventDefault();
                        if (e.button === 0) {
...
export default EvaluationSalesFilteredCompsList;
