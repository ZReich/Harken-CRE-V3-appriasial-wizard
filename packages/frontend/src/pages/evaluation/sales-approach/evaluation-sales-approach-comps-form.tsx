...
import EvaluationFilterMapHeaderOptions from './evaluation-sales-filter-menu-options';
import EvaluationFilterLandMapHeaderOptions from './evaluation-sales-filter-menu-options-map-side';
...
const EvaluationSalesCompsApproach: React.FC = () => {
                ...
                return (
                  <Form className="w-full">
                    {activeType === 'building_with_land' ? (
                      <EvaluationFilterMapHeaderOptions
                        comparisonBasisView={comparisonBasisView}
                      />
                    ) : (
                      <EvaluationFilterLandMapHeaderOptions
                        comparisonBasisView={comparisonBasisView}
                      />
                    )}
                  </Form>
...
export default EvaluationSalesCompsApproach;
