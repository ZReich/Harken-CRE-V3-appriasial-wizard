...
import ResidentialAiCostCompsTable from '../residential-cost-approach/residential-cost-approach-ai-comp-table';
import { UploadCompsModalProps } from '@/pages/comps/Listing/comps-table-interfaces';
import { toast } from 'react-toastify';

const ResidentialUploadSalesCompsModal = ({
  open,
  onClose,
  setCompsModalOpen,
  setCompsData,
...
export default ResidentialUploadSalesCompsModal;
