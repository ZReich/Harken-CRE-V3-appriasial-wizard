...
const ResidentialCompsAdjustmentNoteModal = ({
  setOpen,
  open,
  editorText,
  handleSave,
  ...
  console.log(indexNumber,'indexnumberfdf')
  const adjustmentData=values.tableData.find((_ele:any, index:any) => index === indexNumber);
  const adjustmentNote=adjustmentData?.adjustment_note;
...
export default ResidentialCompsAdjustmentNoteModal;
