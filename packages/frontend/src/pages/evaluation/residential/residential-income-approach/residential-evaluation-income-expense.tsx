...
export const ResidentialIncomeExpense = ({
  analysis_type,
  isFetching,
  effectiveIncome,
  totalAnnualIncomess,
  ...
  useEffect(() => {
    if (!manualChange) {
      if (values?.operatingExpenses) {
        ...
        const totalAnnualAmount = operatingExpense.reduce((total, item) => {
          return total + parseFloat(item.annual_amount || 0);
        }, 0);

        setFieldValue(ResidentialIncomeApproachEnum.TOTAL_OE_ANNUAL_AMMOUNT, totalAnnualAmount);
        const TOTAL_INCOME = values.other_total_annual_income + effectiveIncome;
        const NetIncome = TOTAL_INCOME - totalAnnualAmount;
        if (
          values.incomeSources.length >= 1 &&
          values.incomeSources.some((source) => source.annual_income == 0)
        ) {
          setFieldValue(ResidentialIncomeApproachEnum.TOTAL_NET_INCOME, 0);
        } else {
          setFieldValue(ResidentialIncomeApproachEnum.TOTAL_NET_INCOME, NetIncome);
        }
      }
    }
  }, [
  ...
  const handleAnnualAmountChange = (i: number, event: string) => {
    ...
    setFieldValue(`${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.PERCENTAGE_OF_GROSS}`, divide);

    const divide_sf = events / values.total_sq_ft;
    const roundedPercentage_sf = divide_sf.toFixed(2);
    setFieldValue(
      `${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.TOTAL_PER_SQ_FT}`,
    ...
    if (values.comparison_basis === ResidentialIncomeApproachEnum.BED) {
      ...
      setFieldValue(`${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.TOTAL_PER_BED}`, beds);
      ...
      setFieldValue(`${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.TOTAL_PER_UNIT}`, beds);
    }

    handleInputChange(
      handleChange,
      `${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.ANNUAL_AMOUNT}`,
  ...
  useEffect(() => {
    ...
    if (values.boolean) {
      ...
      setFieldValue(ResidentialIncomeApproachEnum.OPERATING_EXPENSES, operatingExpenses);
    }
  ...
  useEffect(() => {
    ...
    if (values.total_oe_annual_amount == 0) {
      setFieldValue(ResidentialIncomeApproachEnum.TOTAL_OE_GROSS, 0);
      setFieldValue(ResidentialIncomeApproachEnum.TOTAL_PER_SQ_FT, 0);
      setFieldValue(ResidentialIncomeApproachEnum.TOTAL_OE_PER_SQUARE_FEET, 0);
    }
    const TOTAL_INCOME =
  ...
  useEffect(() => {
    if (bool) {
      ...
      setFieldValue(ResidentialIncomeApproachEnum.TOTAL_NET_INCOME, netIncome);
      if (values.total_oe_annual_amount == 0) {
        setFieldValue(ResidentialIncomeApproachEnum.TOTAL_NET_INCOME, values.adjusted_gross_amount);
      }
    }
  ...
  return (
    <>
      ...
      >
        {ResidentialIncomeApproachEnum.EXPENSE}
      </Typography>
      ...
      >
        ...
        >
          ...
          >
            {ResidentialIncomeApproachEnum.OPERATING_EXPENSES_HEADER}
          </Grid>
          <Grid
            item
            xs={2}
          ...
          <Grid
            ...
            className="pl-[24px] mb-[25px] font-bold text-[11px]"
          >
            {ResidentialIncomeApproachEnum.ANNUAL_AMMOUNT}
          </Grid>
          <Grid
            item
            xs={2}
            className="pl-[24px] mb-[25px] font-bold text-[11px]"
          >
            {ResidentialIncomeApproachEnum.PERCENTAGE_OF_ADJUSTED_GROSS}
          </Grid>
          {values.comparison_basis == IncomeApproachEnum.UNIT && (
            <Grid
              ...
              className="pl-[24px] mb-[25px] font-bold text-[11px]"
            >
              {ResidentialIncomeApproachEnum.DOLLAR_PER_UNIT}
            </Grid>
          )}
          {values.comparison_basis === IncomeApproachEnum.BED && (
            <Grid
              ...
              className="pl-[24px] mb-[25px] font-bold text-[11px]"
            >
              {ResidentialIncomeApproachEnum.DOLLAR_PER_BED}
            </Grid>
          )}
          <Grid
            item
            ...
            className="pl-[24px] mb-[25px] font-bold text-[11px]"
          >
            {analysis_type === ResidentialIncomeApproachEnum.DOLLAR_PER_ACRE ? ResidentialIncomeApproachEnum.DOLLAR_PER_AC : ResidentialIncomeApproachEnum.DOLLAR_PER_SF}
          </Grid>
          <Grid
            item
            xs={2}
          ...
          <FieldArray
            name={ResidentialIncomeApproachEnum.OPERATING_EXPENSES}
            render={(arrayHelpers) => (
              <>
                  ...
                  ? values.operatingExpenses.map((zone: any, i: number) => {
                    return (
                      <>
                        ...
                        >
                          <StyledField
                            name={`${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.NAMES}`}
                            style={{
                              background: '#fff',
                            ...
                            onChange={(
                              ...
                              handleInputChange(
                                handleChange,
                                `${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.NAMES}`,
                                input
                              );
                            }}
                        ...
                        <Grid item xs={2} className="pl-[24px] my-[2px]">
                          <StyledField
                            ...
                            name={`${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.ANNUAL_AMOUNT}`}
                            style={{
                              background: '#fff',
                              borderBottomWidth: '1px',
                            }}
                        ...
                        <Grid item xs={2} className="pl-[24px] my-[2px]">
                          <StyledField
                            label={<span className="font-semibold"></span>}
                            name={`${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.PERCENTAGE_OF_GROSS}`}
                            style={{
                              background: '#f5f5f5',
                              borderBottomWidth: '1px',
                              borderStyle: 'dotted',
                        ...
                        {values.comparison_basis ==
                          IncomeApproachEnum.UNIT && (
                            <Grid item xs={1} className="pl-[24px] my-[2px]">
                              <StyledField
                                label={<span className="font-semibold"></span>}
                                name={`${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.TOTAL_PER_UNIT}`}
                                style={{
                                  background: '#f5f5f5',
                                  borderBottomWidth: '1px',
                                  borderStyle: 'dotted',
                                ...
                                onChange={(
                                  ...
                                  handleInputChange(
                                    handleChange,
                                    `${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.TOTAL_PER_UNIT}`,
                                    input.toString()
                                  );
                                }}
                                value={
                        ...
                        {values.comparison_basis ===
                          IncomeApproachEnum.BED && (
                            <Grid item xs={1} className="pl-[24px] my-[2px]">
                              <StyledField
                                label={<span className="font-semibold"></span>}
                                name={`${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.TOTAL_PER_BED}`}
                                style={{
                                  background: '#f5f5f5',
                                  borderBottomWidth: '1px',
                                  borderStyle: 'dotted',
                        ...
                        <Grid
                          ...
                          xs={
                            localStorage.getItem('activeType') ===
                              ResidentialIncomeApproachEnum.RESIDENTIAL
                              ? 2
                              : values.comparison_basis ===
                                IncomeApproachEnum.SF
                                ? 2
                                : 1
                          }
                        ...
                        >
                          <StyledField
                            name={`${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.TOTAL_PER_SQ_FT}`}
                            style={{
                              background: '#f5f5f5',
                              borderBottomWidth: '1px',
                              borderStyle: 'dotted',
                        ...
                        <Grid item xs={2} className="pl-[24px] my-[2px]">
                          <StyledField
                            label={<span className="font-semibold"></span>}
                            name={`${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.COMMENTS.toLowerCase()}`}
                            style={{
                              background: '#fff',
                              borderBottomWidth: '1px',
                            }}
                            onChange={(
                              ...
                              handleInputChange(
                                handleChange,
                                `${ResidentialIncomeApproachEnum.OPERATING_EXPENSES}.${i}.${ResidentialIncomeApproachEnum.COMMENTS.toLowerCase()}`,
                                input
                              );
                            }}
                            ...
                            <Icons.RemoveCircleOutlineIcon
                              ...
                              onClick={() => {
                                ...
                                const remove_account =
                                  ...
                                  removedAmount;
                                setFieldValue(
                                  ResidentialIncomeApproachEnum.TOTAL_OE_ANNUAL_AMMOUNT,
                                  remove_account
                                );

                                const remove_egi =
                                  values.total_oe_gross - removedEgi;
                                setFieldValue(ResidentialIncomeApproachEnum.TOTAL_OE_GROSS, remove_egi);

                                const remove_sf =
                                  values.total_oe_per_square_feet - removedSf;
                                setFieldValue(
                                  ResidentialIncomeApproachEnum.TOTAL_OE_PER_SQUARE_FEET,
                                  remove_sf
                                );
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="mt-[3px] pl-2 text-[11px] cursor-pointer whitespace-nowrap">
                        {ResidentialIncomeApproachEnum.NEW_OPERATING_EXPENSE}
                      </span>
                    </div>
                  </div>
                </Grid>
        ...
        >
          <Grid item xs={2} className="pl-[24px]">
            <div className="font-bold text-[11px]">{ResidentialIncomeApproachEnum.TOTAL_EXPENSES}</div>
          </Grid>
          <Grid item xs={2}></Grid>
          <Grid item xs={2} className="pl-[24px]">
          ...
          {values.comparison_basis == 'Unit' && (
            <Grid item xs={1} className="pl-[24px]">
              ...
              <div className="text-[11px]">{ResidentialIncomeApproachEnum.TOTAL}</div>
            </Grid>
          )}
        ...
        <Grid container spacing={2} columns={13} className="px-2 w-full mt-2">
          <Grid item xs={2} className="pt-[7px] pl-[24px]">
            <div className="font-bold text-[11px]">
              {ResidentialIncomeApproachEnum.NET_OPERATIING_INCOME}
            </div>
          </Grid>
          <Grid item xs={2}></Grid>
          <Grid item xs={2} className=" pl-[24px]">
        ...
        >
          <Grid item xs={2} className="pt-[7px] pl-[24px]">
            <div className="font-bold text-[11px]">{ResidentialIncomeApproachEnum.EXPENSES_NOTES_HEADER}</div>
          </Grid>
          <Grid item xs={14}>
            <TextEditor
