...
import ResidentialCostImprovementDepreciation from './residential-cost-improvement-depriciation';
import ErrorOutlineIcon from '@mui/icons-material/ErrorOutline';
import { IncomeApproachEnum } from '@/pages/appraisal/Enum/AppraisalEnum';
export const ResidentialCostImprovement = ({
  updateData,
  totalSqft,
  totalAdjustedCost,
                  ...
                  >
                    ...
                    <Grid item xs={2} className="pl-[24px] break-all">
                      <div className="flex items-center">
                        ...
                        <Tooltip
                          title={<ResidentialCostImprovementDepreciation />}
