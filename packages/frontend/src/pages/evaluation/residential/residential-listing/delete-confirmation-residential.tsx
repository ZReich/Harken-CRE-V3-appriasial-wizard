...
const DeleteModalResidentialListing: React.FC<ConfirmationModalContentProps> = ({
  close,
  deleteId,
  setArrayAfterDelete,
}) => {
  const { mutate } = useMutate<ResponseType, any>({
    queryKey: 'res-evaluations/delete',
    endPoint: `res-evaluations/delete/${deleteId}`,
...
export default DeleteModalResidentialListing;
