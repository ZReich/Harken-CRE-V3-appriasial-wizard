...
import crossImage from '../../../../images/crop.png';
...
const AdnavceFilterResidential: React.FC<MapFilterProps> = ({
  isOpen,
  setIsOpen,
  onApplyFilter,
}) => {
                  ...
                  <Form>
                    <Box className="rounded relative flex items-center p-4 bg-[#E7F6FA]">
                      <Box className="advance-Filter text-customDeeperSkyBlue font-bold text-base">
                        {EvaluationListingEnum.ADVANCED_FILTER}
                      </Box>
                    ...
                    <div className="p-5" style={{ marginBottom: '200px' }}>
                      <div className="grid grid-cols-3 gap-5">
                        <Box className="text-left font-semibold col-span-3 text-sm">
                          {EvaluationListingEnum.SEARCH_TYPE}
                        </Box>
                        <div className="w-full">
                          <CustomSelect
                            label={EvaluationListingEnum.SELECT_TYPE}
                        ...
                        <Box className="text-left font-semibold col-span-3 text-sm">
                          {EvaluationListingEnum.LOCATION}
                        </Box>
                        ...
                        <div className="w-full ">
                          <StyledFieldFilter
                            label={EvaluationListingEnum.STREET_ADDRESS}
                            name="streetAddress"
                            type="text"
                            onChange={(e: SelectChangeEvent<string>) => {
                        ...
                        <Box className="text-left font-semibold col-span-3 text-sm py-3">
                          {EvaluationListingEnum.ADDITIONAL_CRITERIA}
                        </Box>
                        <DatePickerComp
                          label={
                            <p className="text-base">
                              {EvaluationListingEnum.SALE_DATE_START}
                            </p>
                          }
                        ...
                        <DatePickerComp
                          label={
                            <p className="text-base">
                              {EvaluationListingEnum.SALE_DATE_END}
                            </p>
                          }
...
export default AdnavceFilterResidential;
