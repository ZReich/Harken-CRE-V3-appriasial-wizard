...
import { EvaluationListingEnum } from '../../Enum/evaluation-enums';
import LandOnlyEvaluationListingTable from './land-only-index';
import AdnavceFilterResidential from './residential-advance-filter';
const HeaderOptionsLandOnlyResidential = () => {
  ...
  return (
    <>
          ...
          <Box className="flex items-center">
            ...
            <Box className="mx-9">
              <div className="items-end flex">
                ...
                <Icons.Input
                  className="text-[12px] !pb-[6px] w-80"
                  placeholder="Search Evaluation Listings"
      ...
      <LandOnlyEvaluationListingTable
...
export default HeaderOptionsLandOnlyResidential;
