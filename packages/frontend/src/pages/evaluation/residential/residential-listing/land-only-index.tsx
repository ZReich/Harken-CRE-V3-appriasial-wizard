...
import { ListingEnum, PaginationEnum, SortingEnum } from '@/pages/comps/enum/CompsEnum';
...
const LandOnlyResidentialListingTable: React.FC<CompsListingMapProps> = ({
          ...
          <TableBody>
            {data.map((row: any) => (
              <TableRow key={row.id}>
                ...
                <TableCell>
                  {row.evaluation_approaches_types
                    .map((type: string) => {
                      switch (type) {
                        case 'sale':
                          return 'S';
...
export default LandOnlyResidentialListingTable;
