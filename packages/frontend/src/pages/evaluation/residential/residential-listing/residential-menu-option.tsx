...
import ResidentialListingTable from '.';
import AdnavceFilterResidential from './residential-advance-filter';
const HeaderOptionsResidential = () => {
  ...
  const createSales = () => {
    ...
    localStorage.removeItem('initialIncomePercentage1');
    localStorage.removeItem('initialSalesPercentage1');
    localStorage.removeItem('initialCostPercentage1');
...
export default HeaderOptionsResidential;
