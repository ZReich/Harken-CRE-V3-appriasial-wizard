...
export const ResidentialPropertyDetails = ({ validationSchema }: any) => {
  ...
  const sanitizeInpuAppraisalFile1 = (value: string): string => {
      ...
      <div>
        ...
        <div className="mt-[6px]">
          ...
          <Grid container spacing={3} className="mt-1 items-end">
            <Grid item xs={6} xl={3} className="pt-4">
              <Autocomplete
          ...
          <Grid container spacing={3} className="mt-4 items-end">
            ...
            <Grid item xs={3} className="pt-2 items-end">
                ...
                <ToggleButton
                  ...
                  className={
                    values.last_transfer_date_known === 'yes'
                      ? activeToggle
                      : 'border-0 text-[#90bcc8] bg-transparent'
                  }
                >
          ...
          <Grid container spacing={3} className="mt-3 items-end">
            <Grid item xs={6} className="property-legal pt-2 textareaField">
              <TextAreaField
            ...
            <Grid
              ...
              xs={values.property_rights === AmenitiesEnum.TYPE_MY_OWN ? 3 : 6}
            >
              <SelectTextField
          ...
          <Grid container spacing={3} className="mt-3 items-end">
            <Grid item xs={6} xl={3} className="pt-2">
              <StyledField
                ...
                type="text"
                onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                  const input = sanitizeInpuAppraisalFile1(e.target.value);
