...
const EvaluationmultiFamilyMapSideFilteredListing: React.FC<
...
> = ({
  ...
  console.log(setApiPaginationMeta);
  ...
  console.log(setIsLoadingApi, setApiData);
  ...
  const fetchComposData = async (values: any, setValues: any) => {
    try {
      ...
      const response = await axios.get(
        `evaluations/get-multi-family-approach?evaluationId=${id}&evaluationScenarioId=${salesId}`,
        {}
      );
  ...
  const backToApproach = () => {
    navigate(
      `/evaluation/multi-family-approach?id=${id}&evaluationId=${salesId}`
    );
  };
...
export default EvaluationmultiFamilyMapSideFilteredListing;
