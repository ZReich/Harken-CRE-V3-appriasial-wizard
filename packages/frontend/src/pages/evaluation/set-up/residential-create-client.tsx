...
import ResidentialClientForm from './residential-create-client-form';

const ResidentialCreateClientModal: React.FC<
  ...
  return (
    <>
      ...
      >
        ...
        <DialogContent>
          <ResidentialClientForm handleCloseModal={handleCloseModal} />
        </DialogContent>
      </Dialog>
    </>
  );
...
export default ResidentialCreateClientModal;
