...
const EvaluationClientForm = ({ handleCloseModal }: any) => {
        ...
        onSubmit={async (values, actions) => {
          ...
          try {
            ...
            if (
              ...
              responseMessage.message &&
              window.location.pathname.includes('update-evaluation-set-up')
            ) {
              handleCloseModal();
            } else if (
              responseMessage.message &&
              window.location.pathname.includes('evaluation-set-up')
            ) {
              handleCloseModal();
            } else {
...
export default EvaluationClientForm;
