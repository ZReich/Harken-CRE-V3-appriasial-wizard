...
import { prepareSubmitPayload, validateEvaluationSetupFields } from '@/utils/evaluationUtils';
...
import EvaluationCreateClientModal from '@/pages/evaluation/set-up/evaluation-create-client';
import EvaluationMenuOptions from '@/pages/evaluation/set-up/evaluation-menu-options';
import { createEmptyScenario, getApproachOptions } from './evaluation-approach-config';
import { EvaluationEnum, EvaluationSetUpEnum, ScenarioEnum } from './evaluation-setup-enums';
import { ScenarioItem } from './evaluation-setup-types';
// Type guard function to ensure scenarios are properly typed
const getTypedScenarios = (scenarios: any[]): ScenarioItem[] => {
  return scenarios as ScenarioItem[];
};
        ...
        <div className="p-5 xl:px-14 px-4 ">
          ...
          >
            {({
              ...
              // Get properly typed scenarios
              const typedScenarios = getTypedScenarios(values.scenarios);
                                          ...
                                          <Checkbox
                                            onChange={(e) => {
                                              ...
                                              if (values.scenarios.length === 0) {
                                                ...
                                                newScenario[option.key] = e.target.checked ? 1 : 0;
                              ...
                              <Grid container className="mt-4">
                                ...
                                >
                                  <CommonButton
                                    ...
                                    onClick={() => arrayHelpers.push(createEmptyScenario())}
                                  >
                                    <img
                                      src={group3}
                                      alt="add"
                                  ...
                                  >
                                    <Grid item xs={5}>
                                      <StyledField
                                        ...
                                        value={typedScenarios[index].name}
                                        onChange={(e: any) =>
                                          setFieldValue(
