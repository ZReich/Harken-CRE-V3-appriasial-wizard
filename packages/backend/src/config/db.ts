...
import template_configuration from '../models/template_configuration.sequelize';
import template_scenarios from '../models/template_scenarios.sequelize';
...
async function initialize() {
	...
	db.template_configuration = template_configuration(sequelize, DataTypes);
	db.template_scenarios = template_scenarios(sequelize, DataTypes);
	...
	db.template.hasMany(db.template_configuration, {
		foreignKey: 'template_id',
		sourceKey: 'id',
		as: 'configurations',
	});

	db.template_configuration.belongsTo(db.template, {
		foreignKey: 'template_id',
	});

	db.template.hasMany(db.template_scenarios, {
		foreignKey: 'template_id',
		sourceKey: 'id',
		as: 'template_scenarios',
	});

	db.template_scenarios.belongsTo(db.template, {
		foreignKey: 'template_id',
	});
