...
const appraisal_income_approaches = (sequelize, DataTypes, model) => {
	const appraisal_income_approaches = sequelize.define(
		...
		},
		{
			...
			tableName: 'appraisal_income_approaches',
			hooks: {
	...
	appraisal_income_approaches.hasMany(model.appraisal_income_approach_op_exp, {
		foreignKey: 'appraisal_income_approach_id',
		sourceKey: 'id',
		as: 'operatingExpenses',
	});
	appraisal_income_approaches.hasMany(model.appraisal_income_approach_source, {
		foreignKey: 'appraisal_income_approach_id',
		sourceKey: 'id',
		as: 'incomeSources',
	});
	appraisal_income_approaches.hasMany(model.appraisal_income_approach_other_source, {
		foreignKey: 'appraisal_income_approach_id',
		sourceKey: 'id',
		as: 'otherIncomeSources',
	});
	return appraisal_income_approaches;
};
export default appraisal_income_approaches;
