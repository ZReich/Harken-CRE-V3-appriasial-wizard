...
export const scenarioSchema = Joi.object({
	...
	has_lease_approach: Joi.number().optional(),
	has_cap_approach: Joi.number().optional(),
	has_multi_family_approach: Joi.number().optional(),
...
export const addScenarioSchema = Joi.object({
	...
	has_lease_approach: Joi.number().valid(0, 1).optional(),
	has_cap_approach: Joi.number().valid(0, 1).optional(),
	has_multi_family_approach: Joi.number().valid(0, 1).optional(),
