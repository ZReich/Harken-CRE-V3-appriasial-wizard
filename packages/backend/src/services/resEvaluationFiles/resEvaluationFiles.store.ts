...
import { IEvaluationFiles } from '../resEvaluations/IResEvaluationsService';
import { IEvaluationFilesData, IFilesPosition } from './IResEvaluationFilesService';
const EvaluationFiles = database.res_evaluation_files;

export default class ResEvaluationFilesStore {
	public static OPERATION_UNSUCCESSFUL = class extends Error {
		constructor() {
			console.log('ResEvaluationFilesStore', EvaluationFiles);
