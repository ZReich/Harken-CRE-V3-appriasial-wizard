...
export const userAddUpdateSchema = Joi.object().keys({
	...
	include_background_in_pdf: Joi.number().valid(0, 1).optional(),
	include_affiliations_in_pdf: Joi.number().valid(0, 1).optional(),
	include_education_in_pdf: Joi.number().valid(0, 1).optional(),
	include_responsibility_in_pdf: Joi.number().valid(0, 1).optional(),
