...
import { IOtherIncomeSource } from './IEvaluationIncomeOtherSource';
import { EvaluationsEnum } from '../../utils/enums/EvaluationsEnum';
const EvalIncomeOtherSource = database.eval_income_approach_other_source;
export default class EvaluationOtherIncomeStore {
