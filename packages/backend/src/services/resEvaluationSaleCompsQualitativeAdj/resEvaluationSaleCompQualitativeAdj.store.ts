...
import { ISaleCompsQualitativeAdj } from './IResEvaluationSaleCompQualitativeAdj';
const EvaluationSaleCompsQualitativeAdj = database.res_eval_sales_approach_qualitative_comp_adj;
export default class ResEvaluationSalesCompQualitativeAdjStore {
	...
	public async updateAdjustments(
		...
		try {
			const { adj_key, res_evaluation_sales_approach_comp_id, ...rest } = attributes;
