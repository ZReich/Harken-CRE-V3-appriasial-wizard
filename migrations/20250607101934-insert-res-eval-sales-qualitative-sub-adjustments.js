...
module.exports = {
  async up(queryInterface, Sequelize) {
    const tableName = "res_eval_sales_approach_qualitative_sub_adj";
    ...
    // Check if res_evaluation_sales_approaches exists before inserting data
    ...
    for (const adj of adjustments) {
      await queryInterface.sequelize.query(`
        ...
        WHERE NOT EXISTS (
          ...
          WHERE subAdjustment.res_evaluation_sales_approach_id = salesApproach.id
  ...
  async down(queryInterface) {
    await queryInterface.sequelize.query(`
      DELETE FROM res_eval_sales_approach_qualitative_sub_adj
      WHERE adj_key IN (
        'office_area',
        'building_size',
        'effective_age',
