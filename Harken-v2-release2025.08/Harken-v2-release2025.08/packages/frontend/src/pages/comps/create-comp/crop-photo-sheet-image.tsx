...
const CropImagePhotoSheet: React.FC<Props> = ({
  ...
  const [crop, setCrop] = useState<Crop>({
    ...
    height: 50,
    x: 0,
    y: 25, // Center vertically: (100 - 50) / 2 = 25
    ...
    <div>
      <input
        ...
        style={{
          ...
          top: '0',
          left: '0',
          height: cropModalOpen ? '0' : '95px', // Hide file input in crop modal
          width: cropModalOpen ? '0' : '100%', // Hide file input in crop modal
          opacity: '0',
          scale: '2',
          pointerEvents: cropModalOpen ? 'none' : 'auto', // Disable pointer events in crop modal
          zIndex: cropModalOpen ? -1 : 1, // Send to back in crop modal
        }}
