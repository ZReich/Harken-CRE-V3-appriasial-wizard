...
const Broker = ({ setDataRequited, passData, sendType, setSearchLoader, hasExistingAddress }: any) => {
  ...
  return (
    <>
      ...
      <Location setDataRequited={setDataRequited} passData={passData} setSearchLoader={setSearchLoader} hasExistingAddress={hasExistingAddress} />
    </>
  );
};
