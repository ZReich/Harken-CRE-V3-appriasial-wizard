...
const EvaluationCapSubjectPropertyAdjustmentNoteModal = ({
  setNoteModalOpen,
  open,
  editorText,
  handleSave,
        ...
        <Box className="overlay-content rounded-lg max-w-[1030px] w-full relative flex flex-col bg-white shadow-zinc-900">
          ...
          {open && (
            <div className="p-4">
              ...
              />
              <Typography variant="caption" color={salesNote?.length > 250 ? 'error' : 'textSecondary'}>
                {salesNote?.length}/250 characters
              </Typography>
...
export default EvaluationCapSubjectPropertyAdjustmentNoteModal;
