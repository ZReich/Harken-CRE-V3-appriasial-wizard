...
import { SortingTypeJson } from '@/pages/comps/comp-form/fakeJson';
...
import EvaluationCapMapListingIntegrated from './evaluation-cap-map-listing-integrated';
...
const EvaluationCapFilterMapHeaderOptions: React.FC<any> = ({
  // passCompsData,
  tableData,
  comparisonBasisView,
}) => {
  ...
  const [uploadCompsStatus] = useState(false);
    ...
    <>
      ...
      {selectedButton == 'android' ? (
        ...
        <>
          ...
          <EvaluationCapMapListingIntegrated
            typeFilter={selectType}
            sidebarFilters={sidebarFilters}
            mapZoom={currentZoom}
...
export default EvaluationCapFilterMapHeaderOptions;
