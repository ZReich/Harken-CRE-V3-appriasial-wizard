...
export const IncomeExpense = ({
  ...
  }, [values.operatingExpenses, totalAnnualAmount]);
  ...
  useEffect(() => {
    if (values.boolean) {
      ...
      if (effectiveGrossIncome > 0) {
        const operatingExpenses = values.operatingExpenses?.map(
  ...
  }, [values.total_oe_annual_amount, setFieldValue]);
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Grid item xs={2} className="pl-0 mb-[25px] font-bold text-[11px]">
            OPERATING EXPENSES
          </Grid>
          <Grid
            item
            ...
            render={(arrayHelpers) => (
              <>
                {values.operatingExpenses && values.operatingExpenses.length > 0
                  ...
                  : null}
                {values.operatingExpenses.length < 7 && (
        ...
        <Grid
          ...
          spacing={2}
          columns={13}
          className="px-2 w-full mt-2 mx-0"
        >
          <Grid item xs={2} className="pt-[7px] pl-0">
            <div className="mt-0 font-bold text-[11px]">
        ...
        >
          <Grid item xs={2} className="pt-[7px] pl-0">
            <div className="mt-0 font-bold text-[11px] mb-1">EXPENSE NOTES</div>
          </Grid>
          <Grid item xs={14} className="pl-0">
            <TextEditor
