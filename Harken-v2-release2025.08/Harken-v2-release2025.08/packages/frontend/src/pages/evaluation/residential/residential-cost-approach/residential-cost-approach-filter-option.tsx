...
import { ListingHeaderEnum, SortingEnum } from '@/pages/comps/enum/CompsEnum';
...
// import GoogleMapLocation from '../../comps/Listing/google-map';
import ResidentialCostCompsAdvanceFilter from './residential-cost-comp-advance-filter';
import ResidentialCostFilteredCompsList from './residential-cost-filtered-comp-listing';
import ResidentialCostFilteredMapSideListing from './residential-cost-map-side-filtered-listing';
...
const ResidentialCostFilterMapHeaderOptions: React.FC<any> = ({
  comparisonBasisView,
}) => {
  ...
  // const [, setSendTypes] = useState<string>('sales');
  const [page, setPage] = useState(1);
  // const [checkType, setCheckType] = useState(
  //   localStorage.getItem('checkStatus') === 'lease'
  //     ? 'leasesCheckbox'
  //     : 'salesCheckbox'
  // );
  const [checkType, setCheckType] = useState(() => {
  ...
  const [, setPassDataCheckType] = useState('');
  ...
  return (
    <>
      ...
      <ResidentialCostCompsAdvanceFilter
        isOpen={isOpen}
        setIsOpen={setIsOpen}
        // sendTypes={sendTypes}
      ...
      />
      {selectedButton == 'android' ? (
        <ResidentialCostFilteredCompsList
        ...
        <div className="flex w-full">
          <div className="2xl:xl:w-8/12 xl:w-7/12 w-6/12 overflow-hidden">
            <GoogleMapLocation GoogleData={mapData} comparisonBasisView={actualComparisonBasis} />
          </div>

          <div className="2xl:xl:w-4/12 xl:w-5/12 w-6/12 relative right-1">
            <ResidentialCostFilteredMapSideListing
              sidebarFilters={sidebarFilters}
              searchValuesByfilter={searchValuesByfilter}
              typeProperty={selectedOptions}
...
export default ResidentialCostFilterMapHeaderOptions;
