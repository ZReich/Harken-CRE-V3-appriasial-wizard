...
const HeaderOptionsEvaluation = () => {
  ...
  localStorage.setItem(
    LocalStorageKeysEnum.ACTIVE_TYPE,
    HeaderEnum.BUILDING_WITH_LAND
  );
  localStorage.setItem(UILabelsEnum.ACTIVE_MAIN, HeaderEnum.EVALUATION);
  localStorage.setItem(UILabelsEnum.ACTIVE_BUTTON, HeaderEnum.COMMERCIAL);
  ...
  return (
    <>
      ...
      <AppraisalListingTable
        ...
        onPermissionDenied={setIsPermissionDenied}
      />
