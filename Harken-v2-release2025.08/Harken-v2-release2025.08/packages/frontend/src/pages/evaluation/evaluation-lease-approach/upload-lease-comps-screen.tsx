...
const LeaseUploadCompsScreen = () => {
  ...
  console.log(
    'Sales comp qualitative adjustment:',
    salesCompQualitativeAdjustment
  );
  console.log('Appraisal specific adjustment:', appraisalSpecificAdjustment);
    ...
    if (updatedCompsData) {
      try {
        ...
        for (let i = 0; i < updatedCompsData.length; i++) {
          ...
          const compPayload = {
            comp_type: localStorage.getItem('activeType'),
            type: localStorage.getItem('checkType') === 'leasesCheckbox' || localStorage.getItem('approachType') === 'leaseCheck' ? 'lease' : 'sale',
            ...comp,
            ai_generated: 1,
            link: false,
          };
...
export default LeaseUploadCompsScreen;
