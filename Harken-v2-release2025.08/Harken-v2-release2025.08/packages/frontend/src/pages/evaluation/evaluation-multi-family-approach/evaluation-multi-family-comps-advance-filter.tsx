                  ...
                  <Form>
                    ...
                    <div className="p-5 overflow-y-auto max-h-[90vh]">
                      <div className="grid grid-cols-3 gap-5">
                        ...
                        <div className="w-ful selecTopMargin">
                          <SelectTextField
                        ...
                        <div className="w-full searchTypeSelectFilter">
                          <AdvanceFilterMultipleSelectCheckmarks
                            key={state} // Add key prop to force re-render when state changes
                        ...
                        <div className="w-full styledFieldFilter">
                          <StyledFieldFilter
                      ...
                      >
                        ...
                        <StyledFieldFilter
                          ...
                          value={localStorage.getItem('land_sf_min') || ''}
                        />
