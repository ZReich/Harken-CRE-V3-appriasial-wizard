...
> = ({
  ...
  console.log(values, hasToggleChanged, isInitialLoad);
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      if (capRateMin && capRateMin > 0) finalFilters.cap_rate_min = capRateMin;
      if (capRateMax && capRateMax > 0) finalFilters.cap_rate_max = capRateMax;
  ...
  useEffect(() => {
    ...
    if (capRateMin && capRateMin > 0) clustersFilters.cap_rate_min = capRateMin;
    if (capRateMax && capRateMax > 0) clustersFilters.cap_rate_max = capRateMax;
    if (propertyTypeArray && propertyTypeArray.length > 0)
