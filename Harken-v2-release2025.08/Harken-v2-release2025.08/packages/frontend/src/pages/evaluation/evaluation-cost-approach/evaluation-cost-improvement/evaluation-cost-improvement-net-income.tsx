...
export const CostImprovementNetIncome = ({
  passOperInc,
  passSf,
  passUnit,
  passBed,
  ...
  const [, setIndicatedSfCapRate] = useState(0);
  ...
  useEffect(() => {
    if (values) {
      const totalCostValuations = totalAdjustedCost + values?.land_value;
      ...
      <>
        ...
        >
          ...
          >
            ...
            <Grid item xs={14} className="pt-2 pl-0">
              {/* <TextAreaField
                label=""
                style={{
                  width: '330%',
