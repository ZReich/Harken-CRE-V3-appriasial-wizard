...
const EvaluationCostApproachSubjectPropertyForm: React.FC = () => {
  ...
  const { data: _data, isLoading: _isEvaluationLoading } = useGet<any>({
  ...
  useEffect(() => {
    if (!isLoadingEvaluation && 
        ...
        costApproachData !== null) {
      setIsDataReady(true);
    }
  }, [isLoadingEvaluation, isLoadingCostData, isLoadingAttributes, allAppraisalTpe, appraisalSpecificAdjustment, costApproachData]);
