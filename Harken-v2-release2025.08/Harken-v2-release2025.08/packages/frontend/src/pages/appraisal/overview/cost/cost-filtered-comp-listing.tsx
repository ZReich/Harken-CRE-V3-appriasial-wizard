...
const CostFilteredCompsList: React.FC<CompsListingMapProps> = ({
  typeFilter,
  ...
  const compsLength =
    ...
    localStorage.getItem('compsLengthcostappraisal');
  ...
  const viewListingItem = (id: number) => {
    ...
    navigate(`/cost-comps-view/${id}/${check}`, {
      state: {
        ...
        approachId: approachIdFromUrl, // Optional parameter
        filters,
      },
    });
  };
  ...
  const handleCheckboxChange = async (
    ...
    // Reset search input when switching between sales and lease
    if (onResetSearch) {
      onResetSearch();
    }
...
export default CostFilteredCompsList;
