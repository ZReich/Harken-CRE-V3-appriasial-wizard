...
const LeaseFilteredCompsList: React.FC<CompsListingMapProps> = ({
  typeFilter,
            ...
            <Box className="round flex items-center gap-4">
              ...
              >
                <input
                  ...
                  // checked={approachType === 'leaseCheck'}
...
export default LeaseFilteredCompsList;
