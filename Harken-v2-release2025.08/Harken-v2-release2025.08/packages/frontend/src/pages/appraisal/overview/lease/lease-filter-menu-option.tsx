...
const LeaseFilterMapHeaderOptions: React.FC<any> = ({
  // passCompsData,
  tableData,
  comparisonBasisView,
}) => {
  ...
  const triggerLocalStorageUpdate = () => {
    ...
    console.log(
      '🔄 LEASE APPRAISAL: Triggered localStorage update for integrated component',
      hasFilterChanged,
      isResetActive
    );
  };
  ...
  const handleInputChange = useCallback(
    debounce((value: string) => {
      console.log('🔄 LEASE APPRAISAL: Search input changed to:', value);
  ...
  const handleToggle1 = (newSelectedButton: string | null) => {
    if (newSelectedButton !== null) {
      console.log(
        '🔄 LEASE APPRAISAL: SF/AC toggle changed to:',
        newSelectedButton
      );
  ...
  // Remove the old handleInputChange function
  // const _oldHandleInputChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  return (
    <>
          ...
          <Box className="flex items-center flex-wrap gap-3">
            ...
            <Box className="selectDropdown">
              <CustomSelectSearch
                ...
                onChange={(e) => {
                  console.log(
                    '🔄 LEASE APPRAISAL: Lease status changed to:',
                    e.target.value
                  );
                  setPage(1);
                ...
                {localStorage.getItem('activeType') === 'land_only' ? (
                  <MultipleSelectLandWithAPI
                    onChange={(transformedArray) => {
                      console.log(
                        '🔄 LEASE APPRAISAL: Land property type changed to:',
                        transformedArray
                      );
                      setPage(1);
                  ...
                  <MultipleSelectWithchangesAPI
                    onChange={(transformedArray) => {
                      console.log(
                        '🔄 LEASE APPRAISAL: Building property type changed to:',
                        transformedArray
                      );
                      setPage(1);
                      setSelectedOptions(transformedArray);
            ...
            <Box className="selectDropdown">
              <CustomSelectSearch
                ...
                onChange={(e: SelectChangeEvent<string>) => {
                  console.log(
                    '🔄 LEASE APPRAISAL: Sort by changed to:',
                    e.target.value
                  );
                  setPage(1);
      ...
      {selectedButton == 'android' ? (
        ...
        <>
          {console.log(
            '🎯 LEASE APPRAISAL - Rendering LeaseAppraisalMapListingIntegrated (selectedButton is NOT android)'
          )}
...
export default LeaseFilterMapHeaderOptions;
