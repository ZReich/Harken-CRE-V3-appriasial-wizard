...
import AppraisalPhotoSheetTable from './AppraisalPhotoSheetTable';
...
const AppraisalPhotoSheet = () => {
  ...
  const { mutate } = useMutate<UploadPhotoPagesResponse, any>({
    ...
    endPoint: `/appraisals/upload-photo-pages/${id}`,
  ...
  const { data } = useGet<any>({
    queryKey: 'appraisals/get-photo-pages',
  ...
  const handleSubmit = (values: any) => {
    ...
    mutate(
      ...
      },
      {
        onSuccess: (res) => {
          setLoader(false);
          navigate(`/property-boundaries?id=${id}`);
        ...
        <>
          <div className="flex items-center justify-between h-[50px] w-[100%] xl:pl-[40px] border-0 border-b border-[#eee] border-solid xl:pr-[70px] px-[15px] map-header-sticky">
            ...
            <div className=" flex items-center">
              ...
              <span className="text-xs">{AppraisalPhotoPagesEnum.HEADER}</span>
            </div>
          </div>
                    ...
                    <Grid container spacing={2}>
                      ...
                      >
                        ...
                        {errors && showValidation && (
                          <div className="text-red-500 text-[11px] leading-loose">
...
export default AppraisalPhotoSheet;
