...
const LeaseFilteredMapSideListing: React.FC<CompsListingMapProps> = ({
  ...
  const compsLength =
    ...
    localStorage.getItem('compsLengthleaseappraisal');
  ...
  // Reset page to 1 when map interaction occurs
  useEffect(() => {
    if (mapInteractionTrigger && page !== 1) {
      setPage(1);
    }
  }, [mapInteractionTrigger, page, setPage]);
