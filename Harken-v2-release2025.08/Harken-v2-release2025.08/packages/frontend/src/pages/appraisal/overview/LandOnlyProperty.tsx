...
export const LandOnlyProperty = ({ passRequired, setDataRequited }: any) => {
  const {
    values,
    setFieldValue,
    errors,
  ...
  console.log('LandOnlyProperty - Current zonings:', values.zonings);
      ...
      <div>
        ...
        >
          <Grid
            container
            spacing={2}
            className="mt-1 px-4 w-full m-0 gap-2 flex flex-nowrap"
          >
            <FieldArray
                            ...
                            <>
                              ...
                              >
                                <Grid
                                  item
                                  key={zone.zone}
                                  className="pt-2.5 pb-[0px] pr-[0px] flex-1 lg:max-w-full max-w-[90px]"
                                >
                                  <SelectTextField
                                ...
                                <Grid
                                  item
                                  className="pt-2.5 pb-[0px] pr-[0px] relative flex-1 lg:max-w-full max-w-[90px]"
                                >
                                  <SelectTextField
