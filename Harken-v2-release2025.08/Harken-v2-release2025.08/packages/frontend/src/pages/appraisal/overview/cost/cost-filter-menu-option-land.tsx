...
import CostFilteredCompsList from './cost-filtered-comp-listing';
import CostAppraisalMapListingIntegrated from './cost-appraisals-map-listing-integrated';
...
const CostFilterLandMapHeaderOptions: React.FC<any> = ({
  // passCompsData,
  tableData,
  comparisonBasisView,
}) => {
  ...
  console.log('compFiltersasasasa', compFilters);
  ...
  const triggerLocalStorageUpdate = () => {
    ...
    console.log(
      '🔄 COST APPRAISAL: Triggered localStorage update for integrated component',
      hasFilterChanged,
      isResetActive
    );
  };
  ...
  const handleToggle1 = (newSelectedButton: string | null) => {
    if (newSelectedButton !== null) {
      console.log(
        '🔄 COST APPRAISAL: SF/AC toggle changed to:',
        newSelectedButton
      );
  ...
  const handleInputChange = useCallback(
    debounce((value: string) => {
      console.log('🔄 COST APPRAISAL: Search input changed to:', value);
  ...
  return (
    <>
      ...
      <Box className="py-6 map-header-sticky">
          ...
          <Box className="flex items-center flex-wrap gap-3">
            ...
            <Box className="selectDropdown">
              <CustomSelectSearch
                ...
                onChange={(e) => {
                  console.log(
                    '🔄 COST APPRAISAL: Comp status changed to:',
                    e.target.value
                  );
                  setPage(1);
                ...
                {localStorage.getItem('activeType') === 'land_only' ? (
                  <MultipleSelectLandWithAPI
                    onChange={(transformedArray) => {
                      console.log(
                        '🔄 COST APPRAISAL: Land property type changed to:',
                        transformedArray
                      );
                      setPage(1);
                  ...
                  <MultipleSelectWithchangesAPI
                    onChange={(transformedArray) => {
                      console.log(
                        '🔄 COST APPRAISAL: Building property type changed to:',
                        transformedArray
                      );
                      setPage(1);
                      setSelectedOptions(transformedArray);
            ...
            <Box className="selectDropdown">
              <CustomSelectSearch
                ...
                onChange={(e: SelectChangeEvent<string>) => {
                  console.log(
                    '🔄 COST APPRAISAL: Sort by changed to:',
                    e.target.value
                  );
                  setPage(1);
      ...
      {selectedButton == 'android' ? (
        ...
        <>
          {console.log(
            '🎯 COST APPRAISAL - Rendering CostAppraisalMapListingIntegrated (selectedButton is NOT android)'
          )}
          <CostAppraisalMapListingIntegrated
            typeFilter={selectType}
            selectedToggleButton={selectedToggleButton}
            sidebarFilters={sidebarFilters}
            searchValuesByfilter={searchValuesByfilter}
...
export default CostFilterLandMapHeaderOptions;
