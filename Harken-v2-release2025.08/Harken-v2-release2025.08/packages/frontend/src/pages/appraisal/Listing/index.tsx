...
const AppraisalListingTable: React.FC<CompsListingMapProps> = ({
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const fetchedData = result?.data?.data?.appraisals || [];
                ...
                <TableCell colSpan={7} style={{ textAlign: 'center', padding: '100px 20px 20px 20px' }}>
                  {isPermissionDenied ? (
                    <p className="text-gray-600">
                      Your user profile does not currently permit access to appraisals. If you need access to this tool, please ask one of your account admins to subscribe.
                    </p>
                  ) : (
...
export default AppraisalListingTable;
