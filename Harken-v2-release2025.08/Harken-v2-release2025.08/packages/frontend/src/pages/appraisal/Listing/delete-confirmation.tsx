...
import { DeleteAppraisalEnum } from '@/pages/comps/enum/CompsEnum';
...
const DeleteModalAppraisalListing: React.FC<ConfirmationModalContentProps> = ({
  ...
  return (
    <div className="w-[383px] h-[320px] rounded-[14px]">
      ...
      <p className="text-center text-xl font-bold">{DeleteAppraisalEnum.ARE_YOU_SURE}</p>
      <div className="flex w-full justify-center">
        <div className="text-sm font-medium w-[322px] h-[40px] text-center">
          {DeleteAppraisalEnum.WARNING_MESSAGE}
        </div>
      </div>
      <div className="flex justify-center pb-2">
        <CommonButton
          ...
          onClick={deleteComps}
        >
          {DeleteAppraisalEnum.DELETE_COMP}
        </CommonButton>
      </div>
      <div className="flex justify-center">
        <CommonButton
