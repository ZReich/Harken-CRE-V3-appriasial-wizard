...
import EditableAppraisalExhibitName from './editable-appraisal-exhibit-name';

const SortableRow = ({ row, deleteListingItem, onUpdate, appraisalId }: any) => {
