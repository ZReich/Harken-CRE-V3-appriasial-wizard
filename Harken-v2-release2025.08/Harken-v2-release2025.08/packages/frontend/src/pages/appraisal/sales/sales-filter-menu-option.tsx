...
// import CompsAdvanceFilter from './comps-advance-filter';
...
const FilterMapHeaderOptions: React.FC<any> = ({
  // passCompsData,
  tableData,
  comparisonBasisView,
}) => {
  ...
  const handleInputChange = useCallback(
    debounce((value: string) => {
      console.log('🔄 SALES APPRAISAL: Search input changed to:', value);
          ...
          <Box className="flex items-center flex-wrap gap-3">
            ...
            <Box className="selectDropdown">
              <CustomSelectSearch
                ...
                onChange={(e) => {
                  console.log(
                    '🔄 SALES APPRAISAL: Comp status changed to:',
                    e.target.value
                  );
                  setPage(1);
                ...
                {localStorage.getItem('activeType') === 'land_only' ? (
                  <MultipleSelectLandWithAPI
                    onChange={(transformedArray) => {
                      console.log(
                        '🔄 SALES APPRAISAL: Land property type changed to:',
                        transformedArray
                      );
                      setPage(1);
                  ...
                  <MultipleSelectWithchangesAPI
                    onChange={(transformedArray) => {
                      console.log(
                        '🔄 SALES APPRAISAL: Building property type changed to:',
                        transformedArray
                      );
                      setPage(1);
                      setSelectedOptions(transformedArray);
            ...
            <Box className="selectDropdown">
              <CustomSelectSearch
                ...
                onChange={(e: SelectChangeEvent<string>) => {
                  console.log(
                    '🔄 SALES APPRAISAL: Sort by changed to:',
                    e.target.value
                  );
                  setPage(1);
            ...
            {localStorage.getItem('activeType') === 'land_only' && (
              <Box>
                <ToggleButtonGroup
                  ...
                  exclusive
                  onChange={(_event: any, newSelectedButton: string | null) => {
                    if (newSelectedButton !== null) {
                      console.log(
                        '🔄 SALES APPRAISAL: SF/AC toggle changed to:',
                        newSelectedButton
                      );
...
export default FilterMapHeaderOptions;
