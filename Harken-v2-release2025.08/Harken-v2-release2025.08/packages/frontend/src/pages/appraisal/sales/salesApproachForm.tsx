...
const SalesApproachForm: React.FC = () => {
    ...
    const fetchAppraisalData = async () => {
      ...
      try {
        ...
        if (!Array.isArray(fetchSpecificApprisalData)) {
          console.error('fetchSpecificApprisalData is not an array:', fetchSpecificApprisalData);
          return;
        }
        
        setAllAppraisalType(fetchSpecificApprisalData);
...
export default SalesApproachForm;
