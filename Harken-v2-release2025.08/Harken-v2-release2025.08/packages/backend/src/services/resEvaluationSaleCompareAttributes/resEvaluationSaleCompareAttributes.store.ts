...
import { ISaleComparisonAttributes } from './IResEvaluationSaleCompareAttributes';
const SaleComparisonAttributes = database.res_eval_sales_approach_comparison_attributes;

export default class ResEvaluationSaleComparisonStore {
	...
	public async update(
		...
		try {
			const { comparison_key, res_evaluation_sales_approach_id, ...rest } = attributes;
			const whereClause = { comparison_key, res_evaluation_sales_approach_id };
