...
import { ISalesComp } from './IResEvaluationSalesApproachComps';
const EvaluationSalesComps = database.res_eval_sales_approach_comps;
const SalesCompsAdjustments = database.res_eval_sales_approach_comp_adj;
export default class ResEvaluationSalesCompsStorage {
