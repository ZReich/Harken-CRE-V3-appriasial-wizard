...
import { SalesSubAdjustments } from './IEvaluationSalesApproachSubAdj';

const SubjectAdjustments = database.eval_sales_approach_subject_adj;
export default class EvaluationSalesSubAdjStorage {
