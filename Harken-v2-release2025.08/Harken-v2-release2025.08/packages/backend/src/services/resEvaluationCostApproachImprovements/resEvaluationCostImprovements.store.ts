...
import { ICostImprovements } from './IResEvaluationCostApproachImprovements';

const EvaluationCostImprovements = database.res_eval_cost_approach_improvements;
export default class ResEvaluationCostImprovementStorage {
