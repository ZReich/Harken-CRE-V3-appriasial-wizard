...
import { SalesSubAdjustments } from './IResEvaluationSalesApproachSubAdj';

const SubjectAdjustments = database.res_eval_sales_approach_subject_adj;
export default class ResEvaluationSalesSubAdjStorage {
