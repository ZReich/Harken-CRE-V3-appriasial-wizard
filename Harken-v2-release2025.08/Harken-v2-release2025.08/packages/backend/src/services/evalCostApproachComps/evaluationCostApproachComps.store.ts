...
import { ICostComp } from './IEvaluationCostApproachComps';

const EvaluationCostComps = database.eval_cost_approach_comps;
const EvaluationCostCompsAdj = database.eval_cost_approach_comp_adj;
export default class EvaluationCostCompsStorage {
