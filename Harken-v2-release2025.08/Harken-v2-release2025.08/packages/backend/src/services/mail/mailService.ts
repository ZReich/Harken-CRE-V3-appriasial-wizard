...
export default class MailService {
	...
	async forgotPasswordContent(user: IUser, url: string) {
        ...
        <mj-body background-color="#F2F4F6">
          <mj-section padding="25px 0" background-color="#F2F4F6" text-align="center">
            <mj-column>
			  <mj-image src="${APP_URL}/images/logo-black@2x.png" alt="Harken CRE Logo" width="94px"></mj-image>
            </mj-column>
          </mj-section>
					...
					<mj-section>
						<mj-column>
							<mj-text align="center">
								<mj-image src="${APP_URL}/images/logo-black@2x.png" height="50" />
							</mj-text>
						</mj-column>
					</mj-section>
					<mj-section>
	...
	async setSendInviteEmailContent(data: ISendInviteServices) {
		...
		const mjmlTemplate = `<mjml>
				...
				<mj-section>
					<mj-column>
					<mj-image width="94px" src="${APP_URL}/images/logo-black@2x.png"/>
					</mj-column>
				</mj-section>
