...
import { ISaleSubQualitativeAdj } from './IAppraisalSaleQualitativeAdj';

const SubQualitativeAdj = database.appraisal_sales_approach_qualitative_sub_adj;
export default class AppraisalSaleSubQualitativeAdjStore {
